    ...
    def profile(self):
        if 'Authorization' in request.headers:
            ...
            if(user):
                ...
                return HttpApiResponse({"id":user.id,"email":user.email,"college":user.college,"name":user.name,"user_type":user.user_type,"phone":user.phone,"aadhar":aadhar,"aadhar_date":str(user.aadhar_date),"pan":pan,"pan_date":str(user.pan_date),"seeded_bank_acc":user.seeded_bank_acc,"seeded_date":str(user.seeded_date)}), 200
