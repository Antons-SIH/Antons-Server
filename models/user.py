...
class UserModel(db.Model):
    ...
    created_at = db.Column(db.DateTime(timezone=True), nullable=False, default=nowTime())
    updated_at = db.Column(db.DateTime(timezone=True), nullable=False, default=nowTime())
